 ...
 *
 */
public enum TemperatureSI implements LocalUnit {
    DEGREES_CELSIUS("\u00B0C", 1, Double.MAX_VALUE); // official postfix unicode for ℃: "\u2103");
    ...
    private TemperatureSI(String postFix, double singleUnitValue, double maxValue) {
