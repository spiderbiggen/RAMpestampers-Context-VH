...
\begin{itemize}
	...
	The connector is the link between the agent and the sdk. The agent needs the connector the run properly in the Tygron Engine. The connector includes information like percepts of the Tygron Engine.
\end{itemize}
